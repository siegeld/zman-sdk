...
Identity:
  ...
  zman: {'vendor': 'Merging Technologies', 'product': 'ZMAN Family', 'serial': 'XXXXXX', 'name': 'ZMAN_Z010'}
...
Sources (2):
  [1] MP60_XXXXXX_1 → 239.1.7.88 (L24, PT=98, map=[0, 1, 2, 3, 4, 5, 6, 7])
  [2] MP60_XXXXXX_2 → 239.2.7.88 (L24, PT=98, map=[8, 9, 10, 11, 12, 13, 14, 15])
